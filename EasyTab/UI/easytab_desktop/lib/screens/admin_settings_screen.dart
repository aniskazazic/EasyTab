  ...
  Future<void> _loadCurrentUser() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        // Koristimo addPostFrameCallback kako bismo bili sigurni da je formKey spreman
  ...
  Future<void> _handleSave() async {
    ...
    try {
      ...
      if (request['birthDate'] is DateTime) {
        request['birthDate'] =
            (request['birthDate'] as DateTime).toUtc().toIso8601String();
      }
  ...
  Widget build(BuildContext context) {
    ...
    return MasterScreen(
      ...
      child: isLoading && user == null
          ...
          : _buildAdminSettings(user),
    );
  }

  Column _buildAdminSettings(User? user) {
    return Column(
      children: [
        Expanded(
          child: FormBuilder(
