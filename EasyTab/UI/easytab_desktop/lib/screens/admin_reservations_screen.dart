  ...
  Future<void> _loadReservations() async {
    ...
    try {
      ...
      if (_selectedLocaleId != null) {
        filter['LocaleId'] = _selectedLocaleId;
      }
  ...
  List<Reservation> get _filteredReservations {
    ...
    if (query.isNotEmpty) {
      list = list.where((r) {
        ...
        return table.contains(query) || locale.contains(query) || guests.contains(query);
      }).toList();
    }
      ...
      child: Card(
        ...
        child: DataTable(
          ...
          columns: const [
            ...
            DataColumn(label: Text('Lokal', style: TextStyle(fontWeight: FontWeight.bold))),
