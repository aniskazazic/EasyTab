...
namespace EasyTab.Subscriber.Consumers
{
    public class ReservationCreatedConsumer
    {
        ...
        public async Task HandleAsync(ReservationCreatedMessage message)
        {
            ...
            var subject = "Rezervacija kreirana — EasyTab";
...
<head>
    ...
    <style>
        ...
        .status-badge {{ display: inline-block; background-color: #fef3c7; color: #92400e; padding: 3px 8px; border-radius: 4px; font-weight: 600; font-size: 13px; }}
...
<body>
    <div class='container'>
        ...
        <div class='body'>
            ...
            <p>Vaša rezervacija je uspješno zaprimljena i trenutno je sa statusom: <span class='status-badge'>Na čekanju</span>.</p>
            ...
            <p>Dobićete obavijest čim lokal potvrdi vašu rezervaciju.</p>
